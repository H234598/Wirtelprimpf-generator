...
- Mode-Wechsel trennt fehlertolerant Mode-Persistenz, Session-Löschung und Event-Dispatch; laufende Generationen werden invalidiert und alte Requests verändern weder Chat noch Controls.
...
- `npm --prefix web test`: 32 Tests, 32 bestanden, 0 fehlgeschlagen.
