...
GENERATOR_OBSERVED_SHA = "4468dc98e740f5e27c08698a94861499fbc58a70"
ARCHIVE_OBSERVED_SHA = "6cb7714255dece467802b987952835f11e1f3dab"
...
CI_JOB_COMMANDS = {
    ...
    "web": (
        ...
        "python3 scripts/build_web_site.py --profile hub --site-url https://wirtelprimpf.telacore.org --expected-domain wirtelprimpf.telacore.org --data-root \"${{ github.workspace }}/data\" --check",
...
def validate_pages_workflows(root: Path) -> None:
    ...
    require(
        yaml_mapping_keys(triggers, 2, "Pages workflow Hub trigger") == ["schedule", "workflow_dispatch"],
